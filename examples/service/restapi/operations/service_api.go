...
func NewServiceAPI(spec *loads.Document) *ServiceAPI {
	return &ServiceAPI{
		...
		GetValuesKeyHandler: GetValuesKeyHandlerFunc(func(params GetValuesKeyParams) middleware.Responder {
			return middleware.NotImplemented("operation GetValuesKey has not yet been implemented")
		}),
		PostValuesKeyHandler: PostValuesKeyHandlerFunc(func(params PostValuesKeyParams) middleware.Responder {
...
type ServiceAPI struct {
	...
	// GetValuesKeyHandler sets the operation handler for the get values key operation
	GetValuesKeyHandler GetValuesKeyHandler
	// PostValuesKeyHandler sets the operation handler for the post values key operation
	PostValuesKeyHandler PostValuesKeyHandler
...
func (o *ServiceAPI) Validate() error {
	...
	if o.GetValuesKeyHandler == nil {
		unregistered = append(unregistered, "GetValuesKeyHandler")
	}

	if o.PostValuesKeyHandler == nil {
		unregistered = append(unregistered, "PostValuesKeyHandler")
	}
...
func (o *ServiceAPI) initHandlerCache() {
	...
	o.handlers["GET"]["/values/{key}"] = NewGetValuesKey(o.context, o.GetValuesKeyHandler)

	if o.handlers["POST"] == nil {
		o.handlers["POST"] = make(map[string]http.Handler)
	}
	o.handlers["POST"]["/values/{key}"] = NewPostValuesKey(o.context, o.PostValuesKeyHandler)
